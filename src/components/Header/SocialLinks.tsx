...
export default function SocialLinks({ setView, view }: TitleAndSocialLinkProps) {
  return (
    <div dir='ltr' className='flex flex-row items-center min-[330px]:gap-6 gap-4'>
      ...
      >
        <svg height='30' aria-hidden='true' viewBox='0 0 16 16' version='1.1' width='30'>
          <path
      ...
      <a
        ...
        href='https://discord.gg/tczYKDWa'
        target='_blank'
        className='overflow-hidden transition hover:scale-105 active:scale-95'
      >
        <svg
      ...
      <a
        rel="noopener"
        title="'Open Source Israel' YouTube Channel"
        href="https://www.youtube.com/@user-sg2ns8fi7d"
        target="_blank"
        className="overflow-hidden transition hover:scale-105 active:scale-95"
      >
        <svg
